...
public class EquipModifier {
    ...
    public static EquipModifier createEquipModifier(EquipKinds equipKind) {
        ...
        switch (equipKind) {
            case WoodenStick:
                equipModifier.setAttackModifier(10);
                equipModifier.setWisdomModifier(5);
                equipModifier.setSpeedModifier(5);
                equipModifier.setPowerModifier(5);
            ...
            case MagicStaff:
                ...
                return equipModifier;
            case LeatherArmor:
                equipModifier.setDefenceModifier(20);
                equipModifier.setWisdomModifier(5);
                equipModifier.setSpeedModifier(5);
                equipModifier.setPowerModifier(5);
                return equipModifier;
            case LeatherPants:
                equipModifier.setDefenceModifier(10);
                equipModifier.setWisdomModifier(5);
                equipModifier.setSpeedModifier(5);
                equipModifier.setPowerModifier(5);
                return equipModifier;
